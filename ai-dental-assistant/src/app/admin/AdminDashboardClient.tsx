...
function AdminDashboardClient() {
  ...
  return (
    ...
    <div className='mb-12 flex justify-between items-center bg-gradient-to-br from-primary/10 via-primary/5 to-background p-8 rounded-3xl border border-primary/20'>
