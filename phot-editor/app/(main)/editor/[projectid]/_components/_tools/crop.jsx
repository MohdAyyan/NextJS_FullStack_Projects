...
function Crop() {
  ...
  }, [activeTool, canvasEditor]); // Add missing dependencies
  ...
  }, [isCropMode, exitCropMode]); // Add missing dependencies
  ...
  const applyCrop = () => {
    ...
    try {
      ...
      const croppedImage = new fabric.Image(selectedImage._element, {
